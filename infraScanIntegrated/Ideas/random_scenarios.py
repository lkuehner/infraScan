...
def _finalize_modal_split_frame(
    ...
    """
    Finalize the modal split scenario DataFrame by calculating growth rates and indices.
        This function takes a DataFrame with columns "scenario", "year", "modal_split" and computes:    
        - "growth_rate": year-over-year percentage change in modal split for each scenario
        - "growth_index": modal split as a percentage of the start year's modal split for each scenario
    """
